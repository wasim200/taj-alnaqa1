...
export async function POST(req: Request) {
    try {
        ...
        const successMessage = isDoubleChance
            ? 'تم تسجيل الكود بنجاح\nمبروك 🎉✨\n لقد دخلت السحب معنا بثلاث فرص لاختيارك الحجم 1000 مل من فيري جولد \nضاعف فرصك بالفوز عند شرائك عبوة أخرى العديد من الجوائز القيمة بانتظارك \nدائماً أنت الرابح ✨👑'
            : 'تم تسجيلك بنجاح في السحب! 🎁\n\nنصيحة: يمكنك زيادة فرصك في الفوز بالسحب عن طريق شراء المزيد من منتجات تاج النقاء.';
